...
<Figure
  src="/image/agent-learn-all-illustrations/01-first-principles.png"
  alt="用第一性原理理解 Agent 名词背后的演化原因"
  caption="先看见概念为什么出现，再去记住它叫什么"
/>

回到主题，因为我没有 Python 基础，处于能看懂基本逻辑但是一些细节看不懂的情况，再加上这段时间比较忙，没有办法静下心来好好学语法。因此在整个学习过程中，**我没有去看代码的具体实现逻辑，只是学习了设计思想和架构**。

<Figure
  src="/image/agent-learn-all-illustrations/02-architecture-first.png"
  alt="先收起代码细节，优先理解 Agent 的设计思想和架构骨架"
  caption="代码细节可以后补，设计思想先建立起来"
/>
...
<Figure
  src="/image/agent-learn-all-illustrations/03-human-abstraction-up.png"
  alt="Agent 发展让人的参与节点从审核代码上移到规定 Spec 和能力边界"
  caption="Agent 越能执行，人越需要定义边界"
/>

**学习 Agent 是为了更好地使用 Agent。**
<Callout type="info" title="我的理念">
