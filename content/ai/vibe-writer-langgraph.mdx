---
title: "从硬编码流水线到 LangGraph：重构我的 AI 写作 Agent"
date: "2026-05-15"
...
后来去看了 [deer-flow](https://github.com/bytedance/deer-flow) 的源码，我才意识到：
...
`job` 对象可以在任何地方被任何人修改。`job.chapters` 这个字段，orchestrator、`_write_chapter`、review 阶段都直接改它，你知道状态被改了，但不知道是谁、什么时候、为什么改的。
