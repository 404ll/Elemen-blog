  ...
  return (
    <nav className="w-full flex items-center justify-between p-4 text-black dark:text-white fixed top-0 left-0 right-0 z-50 backdrop-blur-sm bg-white/10 dark:bg-black/10 transition-colors duration-300"> {/* 毛玻璃效果 */}
      ...
      <div className="flex items-center gap-10">
        <Link href="/blog" className="hover:opacity-70 transition-opacity text-xl font-semibold focus:outline-none focus:ring-2 focus:ring-[#38bdf8]/50 focus:ring-offset-2 rounded-lg p-2 font-zenmaru">博客文章</Link>
        <Link href="/project" className="hover:opacity-70 transition-opacity text-xl font-semibold focus:outline-none focus:ring-2 focus:ring-[#38bdf8]/50 focus:ring-offset-2 rounded-lg p-2 font-zenmaru">项目合集</Link>
        <Link href="/about" className="hover:opacity-70 transition-opacity text-xl font-semibold focus:outline-none focus:ring-2 focus:ring-[#38bdf8]/50 focus:ring-offset-2 rounded-lg p-2 font-zenmaru">关于我</Link>
      </div>
